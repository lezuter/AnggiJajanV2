...
export default function GameDetailClient({ slug }: { slug: string }) {
  ...
  }, [selectedProduct, paymentMethodsRefreshKey]);
    ...
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/checkout`, {
        ...
        body: JSON.stringify({
          ...
          expected_total_amount: selectedPaymentMethod?.total_amount || 0,
        }),
      });
            ...
            <div className="space-y-6">
              ...
              <div className="lg:hidden">
                <OrderSummary
                  ...
                  rows={summaryRows(game.name, selectedProduct, selectedTarget)}
